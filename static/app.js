...
const curiosidades = document.querySelectorAll('.curiosidad-item');

setInterval(() => {
    curiosidades[curiosidadIndex].classList.remove('active');
    curiosidadIndex = (curiosidadIndex + 1) % curiosidades.length;
    curiosidades[curiosidadIndex].classList.add('active');
}, 3000);

// Efecto de aparición escalonada
document.querySelectorAll('.timeline-list li').forEach((li, index) => {
